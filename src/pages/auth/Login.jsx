      ...
      >
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-3xl p-8 sm:p-10 shadow-2xl backdrop-blur-xl">
          <div className="mb-10 text-center">
            <h1 className="text-3xl font-semibold tracking-tight text-[var(--color-app-text)] mb-2">Welcome back</h1>
            <p className="text-[var(--color-text-secondary)]">Sign in to your creator account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="block text-sm font-medium text-[var(--color-text-secondary)]" htmlFor="password">Password</label>
                <Link to="/forgot-password" className="text-xs text-[var(--color-primary)] hover:underline transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[var(--color-primary)] text-white font-medium py-3 px-4 rounded-xl hover:bg-[var(--color-primary-hover)] transition-all flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed mt-4"
            >
              {isLoading ? (
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-[var(--color-text-secondary)]">
              ...
              <Link to="/register" className="text-[var(--color-primary)] hover:underline font-medium transition-colors">
                Sign up
              </Link>
            </p>
          </div>
